...
Shader "Matt/ToonTear02"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_cast_11 = (_Vector1.x).xxxx;
			float4 temp_cast_12 = (_Vector1.y).xxxx;
			float2 temp_cast_13 = (23.6).xx;
			float2 uv_TexCoord118 = i.uv_texcoord * temp_cast_13;
			...
			float4 smoothstepResult170 = smoothstep( temp_cast_11 , temp_cast_12 , appendResult167);
			...
			float2 temp_cast_14 = (temp_output_127_0).xx;
			float2 panner135 = ( temp_output_127_0 * temp_cast_14 + UVCoordinates122);
			...
			float2 temp_cast_18 = (saturate( (normal_lightdir9*_ShadowOffset + _ShadowOffset) )).xx;
			float4 Shadow17 = ( VoidAdded184 * tex2D( _ToonRamp, temp_cast_18 ) );
			...
			c.rgb = ( ( Lighting39 + ( saturate( ( ( ase_lightAtten * normal_lightdir9 ) * pow( ( 1.0 - saturate( ( normal_viewdir10 + _RimOffset ) ) ) , _RimPower ) ) ) * ( _RimColor * ase_lightColor ) ) ) + Spec81 ).xyz;
			c.a = 1;
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 Emission105 = ( tex2D( _Emission, uv_Emission ) + Voidsparkles196 );
...
/*ASEBEGIN
Version=18000
345;73;1107;472;19.39369;912.3975;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;28;-1033.678,96.15681;Inherit;True;Property;_Albedo;Albedo;11;0;Create;True;0;0;False;0;-1;a9dc235eb515b1e42af9da219117b8ec;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;179;-80,-640;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;191;80,-720;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-1000.726,680.1732;Inherit;False;Property;_ShadowOffset;Shadow Offset;5;0;Create;True;0;0;False;0;0;0.42;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;184;1038.254,-1056.291;Inherit;False;VoidAdded;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SamplerNode;19;-628.7829,717.2307;Inherit;True;Property;_ToonRamp;Toon Ramp;2;0;Create;True;0;0;False;0;-1;f662d9e61f860c7428cc30e072e1b6c4;14656c99dff77cb4ba68513ede2b1cb9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-319.3426,664.1503;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.CommentaryNode;106;-305.1224,-126.5737;Inherit;False;931.436;483.1525;Couldn't get light to diminish when texels not lit;4;105;101;197;198;Emission;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;101;-240,-80;Inherit;True;Property;_Emission;Emission;19;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;60;-245.1968,1641.863;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;197;75.43097,19.0831;Inherit;False;196;Voidsparkles;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;198;283.1832,-61.04233;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=F4E2E5FA96DCE24A59DE623AED5F474D8F9D7BB0