...
Shader "Tear04"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode7 = tex2D( _VoidMask, uv_VoidMask );
			float4 clampResult135 = clamp( ( ( 1.0 - tex2DNode7 ) + ( 1.0 - NoiseMask125 ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float2 uv_Albedo = i.uv_texcoord * _Albedo_ST.xy + _Albedo_ST.zw;
			float4 Void31 = ( ( VoidColor127 * NoiseMask125 * tex2DNode7 ) + ( clampResult135 * tex2D( _Albedo, uv_Albedo ) ) );
			o.Albedo = Void31.xyz;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18000
642;136;1280;698;1792.692;583.6678;1.69022;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;50;-1065.64,112.9393;Inherit;False;1044.355;427.9362;Comment;6;111;129;130;133;135;27;Albedo;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;129;-911.7001,190.7;Inherit;False;125;NoiseMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;130;-730.9003,190.7;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;136;-708.3035,83.42819;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;133;-566.6002,185.1;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;111;-618.2868,305.6413;Inherit;True;Property;_Albedo;Albedo;5;0;Create;True;0;0;False;0;-1;14656c99dff77cb4ba68513ede2b1cb9;14656c99dff77cb4ba68513ede2b1cb9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;135;-438.6002,169.1;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-250.4741,163.6744;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;29;-110.4517,-235.2209;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;31;117.8371,-239.7987;Inherit;False;Void;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=9B00A0F44D5F3FFB6E1545B3BA4AA0FBD64609C0